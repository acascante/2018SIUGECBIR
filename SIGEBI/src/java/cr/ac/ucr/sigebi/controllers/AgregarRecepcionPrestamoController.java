...
public class AgregarRecepcionPrestamoController extends BaseController {
    ...
    private void inicializarDatos() {
        ...
        List<Convenio> listConvenios = convenioModel.listarActivosRecibir(unidadEjecutora);
    ...
    public String validarForm(UIViewRoot root) {
        ...
        if (command.getFechaDevolucion().before(command.getFechaIngreso())) {                
            return Util.getEtiquetas("sigebi.label.recepcionPrestamo.error.fechas");
        }
